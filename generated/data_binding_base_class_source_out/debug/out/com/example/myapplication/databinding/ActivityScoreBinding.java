...
public final class ActivityScoreBinding implements ViewBinding {
  ...
  private ActivityScoreBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView4,
  ...
  public static ActivityScoreBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityScoreBinding((ConstraintLayout) rootView, imageView4, score);
    }

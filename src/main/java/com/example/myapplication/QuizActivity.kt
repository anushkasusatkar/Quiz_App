...
//        list.add(QuestionModel("Who is the PM of India","Modi","Rahul","Kejriwal","Ajitdada","Modi"))
//        list.add(QuestionModel("Who is the PM of India","Rahul","Modi","Kejriwal","Ajitdada","Modi"))
//        list.add(QuestionModel("Who is the PM of India","Modi","Rahul","Kejriwal","Ajitdada","Modi"))
//        list.add(QuestionModel("Who is the PM of India","Rahul","Modi","Kejriwal","Ajitdada","Modi"))
//        if(list.size>0) {
//            binding.question.setText(list.get(0).question)
...
//            binding.option4.setText(list.get(0).option4)
//        }
        binding.option1.setOnClickListener { nextData(binding.option1.text.toString()) }
        binding.option2.setOnClickListener { nextData(binding.option2.text.toString()) }
